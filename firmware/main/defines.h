...
#define BIT_TARE			BIT2
#define BIT_CALIBRATE		BIT3
#define BIT_NUM_DECIMALS	BIT4
#define BIT_ADC_FIRE		BIT5
#define BIT_ADC_BREAK		BIT6
#define BIT_ADC_PERIOD		BIT7

//ADC Config Events

//TCP Events
#define BIT_TCPSENDMES_READY	BIT0
#define BIT_TCPRECVCONF_READY	BIT1
...
#define CMD_wcal	('w' << 8 * 3) + ('c' << 8 * 2) + ('a' << 8 * 1) + ('l' << 8 * 0)
